# TEDx Presentation: "Stop Calling It a Dream"
...
> **Presenter's note:** This script is written to be delivered in a conversational, energetic tone. Section timings are estimates. Pause marks are indicated with `[PAUSE]`. Slides or visuals are suggested in `[VISUAL: ...]` cues.

---

## PART 1 — THE INTRODUCTION (≈ 3 minutes)

### Opening moment — no words, just action

`[VISUAL: A short clip or photo of Fré competing — hanging on a wall above the crowd, one arm reaching for the next hold.]`

`[PAUSE — let it breathe for 3 seconds before speaking]`
...
Now — before you start feeling inspired in that slightly uncomfortable way where you're not sure if you should clap or not — let me be very clear about something.
...
## PART 2 — THE PRINCIPLES (≈ 10 minutes)

---

### PRINCIPLE 1 — UPGRADE THE LABEL *(≈ 2 min)*
...
Dreams are for when you're asleep. Dreams are hazy, soft, unreachable — they live in the maybe-someday, the wouldn't-it-be-nice. The moment you call something a dream, you give yourself an exit ramp. Because dreams, by definition, don't have to happen.

When I was a student, I had a wild idea: what if you could build a drone that flew like a bird — not a propeller, but actual flapping wings? That sounded insane. That sounded like a dream.

But I didn't call it a dream. I called it a **project**. My thesis project. And five years later, I had a peer-reviewed, flying, robotic hummingbird. The **KULibrie**. Built in a lab in Leuven.

`[VISUAL: Photo of the KULibrie]`

Yes, a robotic hummingbird. I'm aware that's an odd thing to spend five years on. My mother had questions.

Here's the shift I want you to make — right now, tonight, whatever your "dream" is: **if it is actually possible, stop calling it a dream.**

Call it a project. Projects have timelines. Projects have steps. Projects get done.

The goal was always achievable. The language was holding you back.

---

### PRINCIPLE 2 — THE ONLY REAL "L" *(≈ 1.5 min)*

`[VISUAL: The letter "L" — then the word "REGRET"]`

I hear this one all the time: *"What if I fail?"*

Let me reframe that for you.

In science — in engineering, in research — we don't "fail". We run **experiments**. And an experiment has no wrong result. The result is just... data. It tells you something. It makes you smarter. It narrows the field.

I competed in my first paraclimbing competition before I was ready. My trainer Tijl told me to enter. I said: "Fine — the moment I can climb 6a, I'll do it." The day I climbed 6a, I entered. First competition, ever — I came third.

Which was embarrassing, frankly, because I'd been planning to use "I didn't podium" as a very convenient excuse never to compete again. The universe did not cooperate.

But the point is: I didn't know that was going to happen. I went in expecting nothing. I just went in.

Because I understood, even then, that the only way to actually **lose** — the only real "L" — is to **not start**.

*"What if?"* That's the question that will haunt you. Not "what if I tried and it didn't work the way I hoped?" — you'll be fine, you'll learn something. But *"what if I had tried?"* — **that** one keeps you up at night when you're 70.

Trying and learning is never a loss. Never starting? That's the only real failure.
...
Here's the thing about XP: it's cumulative. It stacks. Climbing was only announced as a Paralympic sport for the first time last year — 2028 will be the first edition. But the XP of ten years of competitions and training is exactly what puts me in a position to show up and actually compete for that. If I hadn't levelled up through all of it, I wouldn't be ready now.

You are always levelling up. Even when it doesn't feel like it.

---

## PART 3 — THE CLOSE (≈ 2 minutes)

---

`[VISUAL: The fre2028.la logo / website aesthetic — clean, black and white, minimal]`

So why am I telling you all of this?

Because I'm living proof that these principles work. And I want you to see that in real time.
...
I grew up in Antwerp, in a working-class neighbourhood called the Luchtbal. I went to university, built a flying robot, survived a reality TV show, started a company that didn't survive, and somehow ended up as a World Cup medal-winning paraclimber who is now chasing gold at the Paralympics.

None of that was in the plan. There was no plan. There were just projects.
...
You have something. I know you do. Something you've been calling a dream.

Tonight — give it a new name.

Call it a project.

Write down the first step. Just one.

And then do it.

Because the only real "L" — the only way you actually lose — is if you go home tonight, go to sleep, and wake up tomorrow and do nothing.

And *that* would be a waste.

`[PAUSE — look out at the audience]`

From the Luchtbal to Los Angeles.
...
## APPENDIX: SPEAKER NOTES & TIMING GUIDE
...
## APPENDIX: KEY VISUAL SUGGESTIONS
